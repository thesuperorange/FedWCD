...
class _RPN(nn.Module):
    ...
    def __init__(self, din, Temperature=1.):
    ...
    def forward(self, base_feat, im_info, gt_boxes, num_boxes):
        ...
        rpn_cls_prob_DISTLL = self.reshape(rpn_cls_prob_reshape_DISTLL, self.nc_score_out)
        ...
        rois = self.RPN_proposal((rpn_cls_prob.data, rpn_bbox_pred.data,
                                 im_info, cfg_key))
            #------It seems like rois only use for return value, so I didn't generate new proposal for KD
