...
#    print('roibatchloader')
#    cv2.imwrite('roibatchloader_debug.png',blobs['data'][0])
    data = torch.from_numpy(blobs['data'])
#    temp_data2 = data[0].permute(2,0,1)
#    print(temp_data2.size())
#    new_img_PIL = transforms.ToPILImage()(temp_data2).convert('RGB')
#    new_img_PIL.save('debugout.png')
    ...
    if self.training:
        ...
        if ratio < 1:
            ...
            #print('tensor width='+str(int(np.ceil(data_height*ratio))))
