...
def parse_args():
    ...
    parser.add_argument('--model_sub_dir', dest='model_sub_dir',
...
if __name__ == '__main__':
    ...
    input_image_folder = args.image_dir

    print("input_image_folder = {}".format(input_image_folder))
    ...
    imglist = os.listdir(input_image_folder)
